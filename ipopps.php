        ...
        <section id="content"> 
            <section class="main padder" style="padding-top: 75px;"> 
                ...
                <div id="mastercontainer" class=" hidden"style="width: 1100px;" >
                    <h2>Inner Pack Package Unit Opportunities</h2>
        ...
        <script>
                                    ...
                                    function gettable() {
                                        ...
                                        oTable = $('#ptbtable').dataTable({
                                            ...
                                            'sAjaxSource': "globaldata/ippkguopp.php?userid=" + userid + '&includeaudit=' + includeaudit,
                                            buttons: [
                                                'copyHtml5',
                                                'excelHtml5',
                                                'csvHtml5'
