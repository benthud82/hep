...
<html>
    ...
    ?>
    <head>
        <title>OSS - Small Case Pkgu Opps</title>
        ...
        <section id="content"> 
            <section class="main padder" style="padding-top: 75px;"> 
                ...
                <div id="mastercontainer" class=" hidden"style="width: 1100px;" >
                    <h2>Small Case Opportunities</h2>
                    ...
                    <div class="modal-dialog modal-lg">
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title">Small Case Opportunity Help</h4>
                            </div>
                            <div class="modal-body" id="" style="margin: 25px;">
                                <h4 style="font-family: calibri">This list identifies potential opportunities to move small cases from loose pick to case pick.</h4>

                                <ul style="font-family: calibri">
                                    <li>The only package unit is a case package unit of 1.</li>
                                    <li>The item is currently stored in an L02 or L04 location.</li>
                                    <li>The cubic volume of the case is greater than 7000 cubic centimeters.</li>
                                </ul>
                            </div>
                            ...
                            function gettable() {
                                ...
                                oTable = $('#ptbtable').dataTable({
                                    ...
                                    "rowCallback": function (row, data, index) {
                                        ...
                                        if (data[6] === 'SHOW COMMENTS') {  //add class to show comment so modal can be displayed
                                            $('td:eq(6)', row).addClass("showallcomments");
                                        }
                                    },
                                    "order": [[4, "desc"]],
                                    "aoColumnDefs": [
                                    ...
                                    'sAjaxSource': "globaldata/smallcaseopp.php?userid=" + userid + '&includeaudit=' + includeaudit,
                                    buttons: [
                                        'copyHtml5',
                                        'excelHtml5',
                                        'csvHtml5'
